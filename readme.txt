...
Hey there! I'm your new Google Maps Prevent Scroll.

== Description ==

Hey there! I'm your new Google Maps Prevent Scroll.

Looking for a helping hand? [View plugin documentation](https://longtailcreative.com).
...
Installing "Google Maps Prevent Scroll" can be done either by searching for "Google Maps Prevent Scroll" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
